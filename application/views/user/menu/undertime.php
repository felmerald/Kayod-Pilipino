			...
			<div class="col-sm-9">
					...
					<ol class="breadcrumb">
						  ...
						  Undertime
						   <span class="badge">
						  	...
						  	<!-- <a href="<?php echo base_url(); ?>user/employee/undertime">Undertime</a> -->
						  </li>
						  <li class="active">
				...
				<div class="dataTable_wrapper">
						<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tbody>
										<tr>
										<?php if($get_undertime): foreach($get_undertime as $row): ?>
				...
				<a href="#request_undertime" class="btn btn-success" data-toggle="modal">
					Request
				</a>
				<a href="<?php echo base_url(); ?>user/download_undertime" class="btn btn-default" >
					EXPORT TO EXCEL
				</a>
...
<!-- /////Modal///// -->
		...
		<div id="request_undertime" class="modal fade" tabindex="-1" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<strong class="text-success">Undertime Request</strong>
						</div>
						<div class="modal-body">
							<?php echo form_open(base_url().'user/request_undertime'); ?>	
								<input type="hidden" name="user_id" value="<?php echo $this->session->userdata('login_id'); ?>">
								<div class="form-group">
									<small>DATE:</small>
									<input type="date" name="undertime_date" class="form-control" required>
								</div>
							   <div class="form-group">
									<small>NUMBER OF HOURS:</small>
									<input type="number" name="undertime_number_hours" class="form-control" required>
							   </div>
						</div>
